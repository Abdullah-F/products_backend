...
ActiveRecord::Schema.define(version: 2020_03_12_144601) do
  ...
  create_table "products_promotions", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
